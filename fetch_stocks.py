...
for code in STOCK_LIST:
    ...
    try:
        ...
        candles    = make_candles(unique_rows[-30:])
        candles60  = make_candles(unique_rows[-60:])
        candles120 = make_candles(unique_rows[-120:]) if len(unique_rows) >= 120 else make_candles(unique_rows)
